    ...
    <section ref={ref} className="py-20 bg-gray-50 dark:bg-gray-900 relative overflow-hidden" id="contact">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div
          ...
          <h2 className="text-4xl font-bold mb-4 text-center dark:text-white uppercase brand">KEEP IN TOUCH</h2>
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <motion.div
                    ...
                    <a
                      href="https://www.linkedin.com/company/4dsrl"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary-light transition-colors">
                      LinkedIn
