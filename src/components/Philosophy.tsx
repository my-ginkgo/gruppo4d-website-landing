  ...
  const philosophies = [
    {
      ...
      title: "Etica",
      description:
        "Operiamo con trasparenza e integrità, costruendo relazioni basate sulla fiducia e il rispetto reciproco.",
    },
    {
      icon: Brain,
      title: "Innovazione",
    ...
    <section ref={ref} className="py-20 bg-gray-50 dark:bg-gray-900 relative overflow-hidden" id="philosophy">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div
          ...
          <h2 className="text-4xl font-bold mb-4 dark:text-white uppercase brand">La Nostra Filosofia</h2>
