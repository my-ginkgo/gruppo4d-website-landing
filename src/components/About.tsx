...
const About = () => {
  ...
  const stats = [
    { icon: Users, value: "50+", label: "Clienti Soddisfatti", delay: 0.2 },
    { icon: Rocket, value: "100+", label: "Progetti Completati", delay: 0.4 },
    { icon: Target, value: "95%", label: "Tasso di Fidelizzazione", delay: 0.6 },
    { icon: Building2, value: "2", label: "Sedi Operative", delay: 0.8 },
  ];
        ...
        >
          ...
          >
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
              Operiamo nel settore dell'innovazione e della trasformazione digitale, posizionandoci come <strong>DIGITAL INNOVATION PARTNER</strong> per i nostri clienti.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              Fondata a <strong>Reggio Emilia</strong> nel <b>2023</b>, Gruppo4D si distingue per la capacità di trasformare i dati in valore, supportando decisioni strategiche e favorendo una crescita sostenibile.
            </p>
          </motion.div>
