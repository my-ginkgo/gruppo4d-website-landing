    ...
    <section ref={ref} className="py-20 bg-gray-50 dark:bg-gray-900 relative overflow-hidden" id="mission">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div
          ...
          <h2 className="text-4xl font-bold mb-4 dark:text-white uppercase brand">La Nostra Missione</h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Accompagniamo i nostri clienti nel percorso di trasformazione digitale, combinando innovazione e analisi dei
            dati per creare valore strategico.
          </p>
        </motion.div>
