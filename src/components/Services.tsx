...
import { Activity, Briefcase, Cloud, Code, Database, LineChart, Rocket, Server, Users } from "lucide-react";
      ...
      items: [
        {
          ...
          description:
            "Progettiamo applicazioni web e mobile intuitive e performanti, dal concept alla messa in produzione.",
        },
        {
          icon: Database,
    ...
    <section ref={ref} className="py-20 bg-gray-50 dark:bg-gray-900 relative overflow-hidden" id="services">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.h2
          ...
          className="text-4xl font-bold mb-4 text-center dark:text-white uppercase brand">
          I Nostri Servizi
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
